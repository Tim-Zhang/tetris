...
(function() {
  $(function() {
    ...
    return hammertime = Hammer(document).on("tap", function(event) {
      var relative;
      if (APP.status !== 1) {
        return;
      }
