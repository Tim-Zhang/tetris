...
(function() {
  $(function() {
    var APP, BASE, CONFIG, allPieces, c, centerComponent, check, clearLines, compiled, component, computeScore, draw, drawBase, erase, flash, genComponent, getFilled, landed, move, moveDown, moveLeft, moveRight, paintColor, r, resetBase, setBase, transform, _i, _j, _ref, _ref1;
    CONFIG = {
      row: 21,
      col: 12,
      score: [1, 2, 4, 8]
    ...
    computeScore = function(filled) {
      ...
      return console.log(APP.score, 'computed');
    };
    clearLines = function(filled) {
      ...
      return resetBase(filled);
    };
    resetBase = function(filled) {
      _.each(filled, function(row) {
        var i, j, _i, _results;
        _results = [];
