...
(function() {
  $(function() {
    var APP, BASE, CONFIG, allPieces, centerComponent, check, checkFailed, clearLines, compiled, component, componentHandle, computeScore, draw, drawBase, dropBase, erase, fail, flash, genComponent, getFilled, hideInfo, landed, move, moveDown, moveLeft, moveRight, nextComponent, paintColor, pause, previewNext, rebase, restart, resume, setBase, showBtn, showInfo, showScore, start, startFlash, transform;
    CONFIG = {
      row: 21,
      col: 12,
      scoreMap: [1, 2, 4, 8],
